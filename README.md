...
[![Build Status Travis](https://travis-ci.org/raphaelbs/grunt-cache-bust.svg?branch=master)](https://travis-ci.org/raphaelbs/grunt-cache-bust)
[![Build status AppVeyor](https://ci.appveyor.com/api/projects/status/cksa771ay69s47hl?svg=true)](https://ci.appveyor.com/project/raphaelbs/grunt-cache-bust)
[![Dependency Status](https://david-dm.org/raphaelbs/grunt-cache-bust.svg)](https://david-dm.org/raphaelbs/grunt-cache-bust)
...
## PLEASE READ
This is a fork from [hollandben grunt-cache-bust](https://github.com/hollandben/grunt-cache-bust). More information [here](https://github.com/hollandben/grunt-cache-bust/pull/238).
